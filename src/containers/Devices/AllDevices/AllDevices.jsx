            ...
            },
            {
                ...
                render: record => {
                    if (record.standardPortPercent < 100) {
                        return (<div
                            style={{color: "red"}}>{record.normalPortCnt}/{record.standardPortCnt}({record.standardPortPercent}%)</div>)
                    }
                    return (<div
                        style={{color: "green"}}>{record.normalPortCnt}/{record.standardPortCnt}({record.standardPortPercent}%)</div>)
                }
            ...
            },
            {
                ...
                render: record => {
                    if (record.monitoredPortPercent < 100) {
                        return (<div
                            style={{color: "red"}}>{record.monitoredPortCnt}/{record.portToAddCnt}({record.monitoredPortPercent}%)</div>)
                    }
                    return (<div
                        style={{color: "green"}}>{record.monitoredPortCnt}/{record.portToAddCnt}({record.monitoredPortPercent}%)</div>)
                }
